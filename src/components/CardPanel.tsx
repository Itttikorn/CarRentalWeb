...
export default function CardPanel() {
    ...
    // const mockCarRepo = [
    //     {cid: "001", name: "Honda Civic", image: "/img/vaccine1.jpg"},
    //     {cid: "002", name: "Honda Accord", image: "/img/vaccine1.jpg"},
    //     {cid: "003", name: "Toyota Fortuner", image: "/img/vaccine1.jpg"},
    //     {cid: "004", name: "Tesla Model 3", image: "/img/vaccine1.jpg"}
    // ]
